...
class _RecipeHomePageState extends State<RecipeHomePage> {
  ...
  Widget build(BuildContext context) {
    return FirestoreBuilder<RecipeQuerySnapshot>(
        ...
        builder: ((context, AsyncSnapshot<RecipeQuerySnapshot> snapshot,
          ...
          List<RecipeQueryDocumentSnapshot>? querySnapshot =
              snapshot.data?.docs;

          return getBody(querySnapshot, hasError, hasData);
        }));
  }
  ...
  Widget getBody(List<RecipeQueryDocumentSnapshot>? snapshot, bool hasError,
      bool hasData) {
    if (hasError) {
      return const Column(
        children: [
